...
public class Manage {
	...
	public static void main(String[] args) {
		 ...
		 companydaoimpl.saveCompany(company);
		 
		 Company company1 = new Company("Apple", "London");
		 companydaoimpl.saveCompany(company1);
		...
		Product prodbyid = productdaoimpl.viewProductbyId(4);
		...
		Product updateprodbyid = productdaoimpl.updateProductbyId(4, "Iphone 14", "Red", "Great Design");
		System.out.println("Updated Data:     [ "+ "Product Id: " + updateprodbyid.getId() + ", Product Name: " + updateprodbyid.getName() + ", Product Color: " + updateprodbyid.getColor()
		 ...
		 Company comdeletebyid = companydaoimpl.deleteCompanybyId(2);
